function [] = str_plot3d(d3d,frames,z,x,y)
%%str_plot3d: plot beautiful 3D slices
% 
% By Yangkang Chen
% Jan, 2022
% 
...
function [dout]=str_transp(din,plane)
% str_transp: Transpose two axes in a dataset
...
%
% DEMO:
% a=magic(3);b=reshape(a,3,1,3);c=str_transp(b,23);norm(a-c)
