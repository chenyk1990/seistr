function [u1,u2] = str_conv_allpass_i(din,dip,order)
% str_conv_allpass_i: Convolutional operator implemented by an allpass filter (inline direction)
% 
...
for i1=nw+1:n1-nw
    for i2=1:n2-1
        for i3=1:n3
            ...
            for iw=-nw:nw
                u1(i1,i2,i3)=u1(i1,i2,i3)+(din(i1+iw,i2+1,i3)-din(i1-iw,i2,i3))*filt1(iw+nw+1);
                u2(i1,i2,i3)=u2(i1,i2,i3)+(din(i1+iw,i2+1,i3)-din(i1-iw,i2,i3))*filt2(iw+nw+1);
            end
        end
    end
end
